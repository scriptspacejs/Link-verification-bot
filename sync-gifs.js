...
function listLocalGifs() {
    ...
    try {
        ...
        console.log('');
        console.log('📝 To upload to GitHub:');
        console.log('1. Upload your GIF files directly to your GitHub repository root');
        console.log('2. Files should be in the repository root: /filename.gif');
        console.log('3. Your bot will automatically use these files from the repository root');
